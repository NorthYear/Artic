...
function vRemoveManyParallel(done) {
    ...
    model_1.Article.vSaveMany(model_1.allDB, articles).then(function (articles) {
        model_1.Article.vRemoveMany(model_1.allDB, articles.map(function (a) { return a.id; })).then(function () {
...
exports.vRemoveManyParallel = vRemoveManyParallel;
