...
function vFindManyParallel(done) {
    ...
    model_1.Article.vSaveMany(model_1.allDB, articles).then(function (articles) {
        model_1.Article.vFindMany(model_1.allDB, articles.map(function (a) { return a.id; })).then(function (articles) {
...
exports.vFindManyParallel = vFindManyParallel;
